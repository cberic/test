...
#--------------------------------------------------------------------
# Bo Chen 2020-09-18
# Generates .xyz file for XP-PCM calculations from existing
# IRC output file
...
END { 
	...
	#printf("%s\n%s\n%s\n\n", nproc, mem, method) > "geometries.xyz"
	...
	#    energy[array[sortedArray[i]]]) >> "geometries.xyz"
	# Print charge and multiplicity
	#printf("%s\n", chargeAndMulti) >> "geometries.xyz"
